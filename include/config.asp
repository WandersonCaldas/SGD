...
application("lb_listagem_completa") = "Listagem Completa"
application("lb_limpar") = "Limpar"

'LETRA M----------------------
application("lb_mensagem") = "Mensagem"
...
application("lb_sim") = "Sim"
application("lb_situacao") = "Situação"
