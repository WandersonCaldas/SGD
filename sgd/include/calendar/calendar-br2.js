...
Calendar._TT["ABOUT"] =
"Seleção de Data:\n" +
"- Use os \xab, \xbb botões para selecionar o ano\n" +
"- Use os " + String.fromCharCode(0x2039) + ", " + String.fromCharCode(0x203a) + " botões para selecionar o mês\n" +
"- Mantenha o botão do mouse pressionado sobre esses botões para uma seleção mais rápida."; /*+ 
