...
<html lang="en">
    ...
    <body>
        ...
        <!-- Javascript -->
        <script src="/sgd/assets/js/jquery-1.11.1.min.js"></script>
        <script src="/sgd/assets/bootstrap/js/bootstrap.min.js"></script>
        <script src="/sgd/assets/js/jquery.backstretch.min.js"></script>
        <script src="/sgd/assets/js/scripts.js"></script>
        
        <!--[if lt IE 10]>
            <script src="/sgd/assets/js/placeholder.js"></script>
        <![endif]-->
        ...
        <script type="text/javascript">
            ...
            $("#btn_enviar").click(function () {
                ...
                if (txt_email != '') {
                    $.ajax({
                        type: 'POST',
                        url: '/sgd/sistema/Usuario/ManterUsuario.asp?acao=recuperar_senha',
                        data: {                            
            ...
            function EnviarNovaSenha(id) {
                self.location.href = '/sgd/sistema/Usuario/ManterUsuario.aspx?acao=recuperar_senha&id=' + id;
                return;               
            }
        </script>
